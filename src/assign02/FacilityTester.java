...
public class FacilityTester {
	...
	void setUp() throws Exception {
		...
		Facility largeFacility = new Facility();
		largeFacility.addPatient(new CurrentPatient("Jane", "Doe", uHID1, 1010101, date1));
		largeFacility.addPatient(new CurrentPatient("Drew", "Hall", uHID2, 3232323, date2));
		largeFacility.addPatient(new CurrentPatient("Riley", "Nguyen", uHID3, 9879876, date3));
		largeFacility.addPatient(new CurrentPatient("Janis", "D", uHID1, 1111111, date1));
		largeFacility.addPatient(new CurrentPatient("Dane", "H", uHID2, 3232333, date2));
		largeFacility.addPatient(new CurrentPatient("Rick", "N", uHID3, 9879006, date3));
...
//
//	// Larger Facility tests------------------------------------------------------
//	@Test
//	public void testLargeLookupUHID() {
//		Patient expected = new Patient("Drew", "Hall", new UHealthID("BCBC-2323"));
//		Facility largeFacility = null;
//		CurrentPatient actual = largeFacility.lookupByUHID(new UHealthID("BCBC-2323"));
//		assertEquals(expected, actual);
//	}
//
//	@Test
//	public void testLargeLookupPhysicianCount() {
//		ArrayList<CurrentPatient> actualPatients = largeFacility.lookupByPhysician(9879876);
...
//		FacilityGeneric<Object> largeFacility;
//		largeFacility.lookupByUHID(uHID1).updatePhysician(9090909);
